...
public class MyShiroRealm extends AuthorizingRealm  {
	...
	public AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException,UnknownAccountException,LockedAccountException {
		...
		SimpleAuthenticationInfo authenticationInfo=null;
			...
			SysUser suser = loginservice.getUserAndGroupInfo(token.getUsername());
			if (suser == null) {
	    	...
	    	List<SysPermission> permlist=SysUserUtil.filterPersmList(loginservice.findPermissionStr(suser.getUsername()));
	...
	public AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		try{
			if (StringUtil.isNotEmpty(loginname)) {
 	           ...
 	           //用户角色
 	            List<SysRole> rolelist=loginservice.findRolesStr(loginname);
 	            if(rolelist!=null){
 	            ...
 	            //用户权限
	            List<SysPermission> permlist=loginservice.findPermissionStr(loginname);
	            if(permlist!=null){
